<template>
    <q-page class="q-pa-xs">
      <q-card>
        <q-card-section class="bg-grey-1 text-white">
          <div class="text-h6 text-primary text-center">EPARGNES DES MEMBRES</div>
        </q-card-section>
        ...
        <q-tabs v-model="tab"
          ...
          <q-tab no-caps name="saving" label="Voir les épargnes" icon="move_to_inbox" class="text-primary"/>
        ...
        <q-tab-panels v-model="tab">
          <q-tab-panel v-if="this.typeUser === 'Cashier'" name="register">
            <q-card flat>
              <q-card-section class="bg-negative text-white">
                <div class="text-subtitle2">Enregistrer une épargne déposée</div>
              </q-card-section>
              <q-separator />
              <q-card-section>
          ...
          <q-tab-panel name="saving">
            <q-card flat>
              <q-card-section class="bg-primary text-white">
                <div class="text-subtitle2">Epargnes déposées par les membres</div>
              </q-card-section>
              <q-separator />
              <q-card-section>
          ...
          <q-tab-panel v-if="this.typeUser === 'Cashier'" name="add">
            <q-card flat>
              <q-card-section class="bg-accent text-white">
                <div class="text-subtitle2">Réaliser un dépôt électronique d'épargne</div>
              </q-card-section>
              <q-separator />
              <q-card-section>
                <q-form class="full-width">
  ...
  export default {
    data () {
      ...
      if (this.name !== null && this.depositorId !== null && this.devisetosave !== null && this.amounttosave !== null && this.depositdate !== null && this.depositdate !== null ) {
          axios.post(this.$urlServer + 'depositControllers/addDeposit.php', form, {
            ...
            this.$q.dialog({
              title: 'Success',
              message: ("Le dépôt d'épargne a été enregistré avec succès"),
              ok: {
                push: true
              },
              cancel: {
    ...
    methods: {
        ...
        listSavings () {
            axios.get(this.$urlServer + 'depositControllers/listDeposit.php', {
                params: {
